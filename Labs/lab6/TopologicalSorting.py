...
if __name__ == "__main__":
    ...
    s = TopologicalSorting("../../../../Downloads/lab6/graph_example.txt")
    s.print_and_save()

    # Be careful! graph-courses.txt is incomplete. Please finish this txt file at first. 
    s = TopologicalSorting("../../../../Downloads/lab6/graph_courses.txt")
    s.print_and_save()

    s = TopologicalSorting("../../../../Downloads/lab6/graph_spider.txt")
    s.print_and_save()